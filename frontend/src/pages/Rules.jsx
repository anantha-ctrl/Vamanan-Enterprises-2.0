      ...
      <div className="flex-1 lg:ml-72 flex flex-col min-h-screen w-full">
        ...
        <main className="p-4 sm:p-8 md:p-12 lg:p-16 max-w-5xl mx-auto w-full space-y-8 md:space-y-12 pb-32">
          ...
          <div className="mb-8 md:mb-12">
              ...
              <h2 className="text-3xl md:text-5xl font-black text-blue-900 tracking-tighter uppercase italic leading-none">Rules</h2>
          ...
          <div className="bg-white border border-slate-200/60 p-6 md:p-14 rounded-[2rem] md:rounded-[3.5rem] shadow-sm relative overflow-hidden group">
             ...
             <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12 relative z-10">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-900 text-amber-500 rounded-xl md:rounded-[1.5rem] flex items-center justify-center shadow-xl">
                   <Gift size={24} md:size={28} strokeWidth={1.5} />
                </div>
                <h2 className="text-xl md:text-3xl font-black text-blue-900 tracking-tighter uppercase italic leading-tight">How You Earn</h2>
             </div>
             ...
             <div className="grid gap-8 md:gap-10 relative z-10">
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   ...
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-1 md:mb-2 uppercase tracking-widest italic">1% Daily Cashback</h4>
                ...
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   ...
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-1 md:mb-2 uppercase tracking-widest italic">Up to 100 Days</h4>
                ...
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   ...
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-1 md:mb-2 uppercase tracking-widest italic">Starts in 24 Hours</h4>
                ...
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   <div className="w-8 h-8 md:w-10 md:h-10 bg-blue-50 rounded-lg md:rounded-xl flex items-center justify-center text-blue-500 shrink-0 border border-blue-100 group-hover/item:bg-blue-500 group-hover/item:text-white transition-all">
                      <AlertTriangle size={18} md:size={20} strokeWidth={2.5} />
                   </div>
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-1 md:mb-2 uppercase tracking-widest italic">Earnings Limit</h4>
          ...
          <div className="bg-white border border-slate-200/60 p-6 md:p-14 rounded-[2rem] md:rounded-[3.5rem] shadow-sm relative overflow-hidden group">
             ...
             <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12 relative z-10">
                ...
                <h2 className="text-xl md:text-3xl font-black text-blue-900 tracking-tighter uppercase italic leading-tight">Referral Program</h2>
             </div>
             ...
             <div className="grid gap-8 md:gap-10 relative z-10">
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   ...
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-1 md:mb-2 uppercase tracking-widest italic">Eligibility</h4>
                ...
                <div className="flex items-start gap-4 md:gap-6 group/item">
                   ...
                   <div>
                      <h4 className="text-[10px] md:text-[11px] font-black text-blue-900 mb-4 uppercase tracking-widest italic">5-Level Commission</h4>
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4">
                         {[
                           ...
                           <div key={i} className="p-3 md:p-4 bg-slate-50 border border-slate-100 rounded-xl md:rounded-2xl text-center group/tier hover:bg-blue-900 transition-all">
                              <p className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase mb-1 group-hover/tier:text-amber-500">{tier.l}</p>
                              <p className="text-xs md:text-sm font-black text-blue-900 group-hover/tier:text-white italic">{tier.v}</p>
                           </div>
                         ))}
                      </div>
                   </div>
          ...
          <div className="bg-blue-900 p-8 md:p-14 rounded-[2rem] md:rounded-[3.5rem] shadow-2xl relative overflow-hidden border border-white/5">
             ...
             <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-10 relative z-10">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-amber-500 text-blue-900 rounded-xl md:rounded-[1.2rem] flex items-center justify-center shadow-lg">
          ...
          <div className="bg-white border border-slate-200/60 p-6 md:p-14 rounded-[2rem] md:rounded-[3.5rem] shadow-sm">
             <div className="flex items-center gap-3 md:gap-4 mb-8 md:mb-10">
                <div className="w-10 h-10 bg-blue-900 rounded-xl flex items-center justify-center text-amber-500 shadow-lg"><Landmark size={18} md:size={20} /></div>
                <h3 className="text-base md:text-lg font-black text-blue-900 tracking-tighter uppercase italic">Example</h3>
             </div>
             ...
             <div className="grid gap-4 md:gap-6">
                {[
                  ...
                  <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between py-4 md:py-6 border-b border-slate-50 last:border-0">
                    ...
                    <span className={`text-sm md:text-base font-black italic tracking-tight ${row.hl ? 'text-amber-600' : 'text-blue-900'}`}>{row.value}</span>
                  </div>
                ))}
             </div>
             
             <div className="mt-8 md:mt-12 p-6 md:p-8 bg-amber-50 border border-amber-100 rounded-2xl md:rounded-[2rem] flex items-center gap-4 md:gap-6">
                <Zap className="text-amber-500 shrink-0" size={20} md:size={24} strokeWidth={2.5} />
                <p className="text-amber-700 text-[9px] md:text-[10px] font-black uppercase tracking-widest italic leading-relaxed">Activation of 10 qualified nodes enables auxiliary commissions beyond diurnal yields.</p>
             </div>
          </div>
