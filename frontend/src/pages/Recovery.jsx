      ...
      >
        ...
        <div className="text-center mb-10 md:mb-12 mt-6 md:mt-8">
          <motion.div 
            ...
            className="w-20 h-20 md:w-24 md:h-24 mx-auto mb-6 md:mb-8 flex items-center justify-center p-4 bg-blue-900 rounded-[1.8rem] md:rounded-[2rem] shadow-2xl relative group overflow-hidden"
          >
          ...
          <h2 className="text-2xl md:text-3xl font-black text-blue-900 tracking-tighter mb-2 md:mb-3 uppercase italic leading-none">Security Recovery</h2>
        ...
        <AnimatePresence mode="wait">
          ...
          {success && step !== 'reset' && (
             <motion.div 
               initial={{ opacity: 0, y: -10 }} 
               animate={{ opacity: 1, y: 0 }} 
               className="bg-amber-50 border border-amber-100 text-amber-600 p-5 md:p-6 rounded-2xl md:rounded-3xl text-[9px] md:text-[10px] mb-8 text-center font-black uppercase tracking-widest italic flex items-center justify-center gap-3"
             >
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-[1.2rem] md:rounded-[1.5rem] py-5 md:py-6 pl-16 pr-8 outline-none focus:border-amber-600 focus:bg-white transition-all text-sm text-blue-900 font-black italic tracking-tight shadow-inner" 
                  />
                </div>
              </div>
            ...
            >
              <div className="space-y-6 text-center">
                <div className="bg-amber-50 border border-amber-100 p-6 rounded-[2rem] relative overflow-hidden">
                   ...
                   <p className="text-4xl font-black text-blue-900 tracking-[0.2em] italic">{receivedOtp || '------'}</p>
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-[1.5rem] py-6 text-center text-3xl font-black text-blue-900 tracking-[0.5em] outline-none focus:border-amber-600 focus:bg-white transition-all shadow-inner italic" 
                  placeholder="000000"
                />
              </div>
        ...
        <div className="mt-10 md:mt-12 pt-8 border-t border-slate-100 text-center">
           <p className="text-[9px] md:text-[10px] text-slate-400 font-black uppercase tracking-[0.2em] italic">
            Remembered Key? <Link to="/login" className="text-amber-600 hover:text-blue-900 transition-colors underline decoration-amber-500/30 underline-offset-4 ml-1">Return to Authentication</Link>
          </p>
        </div>
      </motion.div>
