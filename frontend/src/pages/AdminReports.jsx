...
const AdminReports = () => {
  ...
  const reportConfig = {
    ...
    withdrawal: { label: 'Withdrawal Reports', icon: Landmark, color: 'text-blue-600', bg: 'bg-blue-50' },
    transaction: { label: 'Transaction Reports', icon: Activity, color: 'text-blue-600', bg: 'bg-blue-50' },
    investment: { label: 'Investment Reports', icon: ShoppingBag, color: 'text-amber-600', bg: 'bg-amber-50' },
    referral: { label: 'Referral Reports', icon: Award, color: 'text-blue-600', bg: 'bg-blue-50' },
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
            <div className="relative">
              ...
              <h1 className="text-5xl md:text-8xl font-black text-blue-900 tracking-tighter uppercase italic leading-[0.8] mb-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-[3rem] p-10 relative overflow-hidden group shadow-sm hover:shadow-xl transition-all duration-500">
               ...
               <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center justify-between mb-12">
                     <div>
                        <h3 className="text-xl font-black text-blue-900 uppercase italic tracking-tighter">{type === 'referral' ? 'Financial Inflection' : 'Transmission Velocity'}</h3>
                  ...
                  <div className="h-64 mb-10">
                     <TrendChart data={data.chart} color={currentConfig.color.includes('amber') ? '#d97706' : '#2563eb'} />
                  </div>
                  <div className="grid grid-cols-3 gap-8 pt-8 border-t border-slate-100">
                     <div>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Aggregate Value</p>
                        <p className="text-2xl font-black text-blue-900 italic tracking-tighter">₹{parseFloat(data.summary.total || 0).toLocaleString()}</p>
                     </div>
                     <div>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">{type === 'referral' ? 'Active Earners' : 'Node Count'}</p>
                        <p className="text-2xl font-black text-blue-900 italic tracking-tighter">{type === 'referral' ? data.summary.unique_earners : data.summary.count || 0}</p>
                     </div>
                     <div>
            ...
            <div className="flex flex-col gap-6">
               ...
               <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 text-blue-900 flex-1 relative overflow-hidden group shadow-sm hover:shadow-xl transition-all duration-500">
                  <div className="w-12 h-12 bg-amber-50 rounded-2xl flex items-center justify-center mb-6 text-amber-600 group-hover:bg-blue-900 group-hover:text-amber-500 transition-all duration-500">
                  ...
                  <h3 className="text-2xl font-black italic tracking-tighter uppercase mb-6 text-blue-900">{type === 'referral' ? (data.summary.count || 0) + ' Transmissions' : (data.summary.registry_count || 0) + ' Node Registry'}</h3>
                  <button onClick={exportData} className="w-full bg-blue-900 hover:bg-amber-600 text-white py-4 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-3 transition-all active:scale-95 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {[
                   ...
                   <motion.div 
                     ...
                     className="bg-blue-900 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl group relative overflow-hidden"
                   >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                 <div className="bg-white border border-slate-200 rounded-[3rem] p-10 shadow-sm relative overflow-hidden group">
                    <div className="flex justify-between items-center mb-8">
                       <div>
                          <h4 className="text-lg font-black italic tracking-tighter text-blue-900 uppercase">Active Yield Protocol</h4>
                    ...
                    <div className="flex items-end gap-4">
                       <h3 className="text-5xl font-black italic tracking-tighter text-blue-900">{data.cycles_summary?.active_cycles || 0}</h3>
                       <div className="mb-2">
                          <span className="bg-amber-50 text-amber-600 text-[10px] font-black px-3 py-1 rounded-full border border-amber-100 flex items-center gap-1.5 shadow-sm">
                    ...
                    <div className="mt-8 grid grid-cols-2 gap-4">
                       <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                          ...
                          <p className="text-lg font-black italic text-blue-900 mt-1">₹{parseFloat(data.cycles_summary?.daily_liability || 0).toLocaleString()}</p>
                       </div>
                       <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                          <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Pending Verification</p>
                          <p className="text-lg font-black italic text-blue-900 mt-1">{data.cycles_summary?.pending_cycles || 0} Cycles</p>
                       </div>
                    </div>
                    <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full blur-3xl -mr-16 -mt-16"></div>
                 </div>

                 <div className="bg-blue-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden border border-white/5 group">
                    <div className="flex justify-between items-center mb-8">
                       <div>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {[
                   ...
                   >
                      <div className="absolute top-0 right-0 p-4">
                        <div className="flex items-center gap-1.5 px-3 py-1 bg-white/5 border border-white/10 rounded-full">
                          <div className={`w-1.5 h-1.5 rounded-full ${card.count > 0 ? 'bg-blue-500 animate-ping' : 'bg-amber-500'} shadow-[0_0_8px_rgba(245,158,11,0.8)]`}></div>
              ...
              <div className="bg-white border border-slate-200 rounded-[3.5rem] p-10 shadow-sm relative overflow-hidden group min-h-[450px]">
                 <div className="flex justify-between items-center mb-10">
                    <div>
                       <h4 className="text-xl font-black italic tracking-tighter text-blue-900 uppercase">Liquidity Outflow Matrix</h4>
                    ...
                    <div className="flex gap-4">
                       <div className="flex flex-col items-end">
                          <span className="text-sm font-black italic text-blue-900">₹{parseFloat(data.summary?.total_amount || 0).toLocaleString()}</span>
                          <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Gross Outflow</span>
                       </div>
                       <div className="w-12 h-12 bg-blue-900 rounded-2xl flex items-center justify-center text-amber-500">
          ...
          {type === 'payout' && (
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {[
                   ...
                   >
                      <div className="absolute top-0 right-0 p-4">
                        <div className="flex items-center gap-1.5 px-3 py-1 bg-white/5 border border-white/10 rounded-full">
                          <div className={`w-1.5 h-1.5 rounded-full ${card.count > 0 ? 'bg-amber-500 animate-ping' : 'bg-amber-500'} shadow-[0_0_8px_rgba(245,158,11,0.8)]`}></div>
              ...
              <div className="bg-white border border-slate-200 rounded-[3.5rem] p-10 shadow-sm relative overflow-hidden group">
                 <div className="flex justify-between items-center mb-10">
                    <div>
                       <h4 className="text-xl font-black italic tracking-tighter text-blue-900 uppercase">Payout Velocity Matrix</h4>
                       <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Institutional Disbursement Trends</p>
                    </div>
                    <div className="w-12 h-12 bg-blue-900 rounded-2xl flex items-center justify-center text-amber-500 shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
               <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-slate-200 rounded-[3rem] p-10 shadow-sm hover:shadow-xl transition-all">
                  <div className="flex items-center justify-between mb-10">
                     <h3 className="text-xl font-black text-blue-900 uppercase italic tracking-tighter">Elite Referrers</h3>
                     <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 border border-blue-100"><Award size={20} /></div>
                  </div>
                     ...
                     {(data.top_referrers || []).map((ref, idx) => (
                        <div key={idx} className="flex items-center justify-between p-5 bg-slate-50/50 rounded-2xl border border-slate-100 hover:bg-white transition-all group">
                           <div className="flex items-center gap-4">
                              <div className="w-12 h-12 bg-blue-900 rounded-xl flex items-center justify-center text-amber-500 font-black italic shadow-lg group-hover:scale-110 transition-transform">{idx + 1}</div>
                              <div>
                                 <p className="text-sm font-black text-blue-900 uppercase italic leading-tight">{ref.name}</p>
                           ...
                           <div className="text-right">
                              <p className="text-lg font-black text-blue-900 italic tracking-tighter">₹{parseFloat(ref.total_earned).toLocaleString()}</p>
                              <p className="text-[8px] font-black text-amber-600 uppercase tracking-widest mt-1 italic">Protocol Yield</p>
                           </div>
                        </div>
                     ))}
               ...
               <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-blue-900 border border-white/5 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="bg-white border border-slate-200 rounded-[3rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500">
             <div className="p-10 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="flex items-center gap-6">
                   ...
                   <div>
                      <h3 className="text-2xl font-black text-blue-900 uppercase italic tracking-tighter">Protocol History</h3>
                ...
                <div className="flex flex-wrap items-center gap-4">
                   <div className="relative group">
                      ...
                      <input 
                        ...
                        className="bg-slate-50 border border-slate-200 rounded-xl py-3 pl-12 pr-6 text-[10px] font-black uppercase italic outline-none focus:border-amber-500/50 w-64 text-blue-900 transition-all shadow-inner"
                      />
                   </div>
                   <div className="relative">
                      ...
                      <select 
                        ...
                        className="bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-10 text-[10px] font-black uppercase italic outline-none focus:border-amber-500/50 text-blue-900 appearance-none cursor-pointer shadow-inner"
                      >
                                ...
                                <td className="py-8 px-10">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <div className="flex flex-col">
                                         <p className="text-sm font-black text-blue-900 uppercase italic tracking-tighter leading-tight">{row.user_name}</p>
