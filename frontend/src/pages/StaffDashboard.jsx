  ...
  if (loading) return (
    <div className="min-h-screen bg-white flex items-center justify-center text-amber-600">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-[10px] font-black animate-pulse uppercase tracking-[0.4em] italic">Accessing Support Matrix...</p>
      </div>
    </div>
  );
        ...
        <header className="bg-white border-b border-slate-100 px-8 py-6 flex justify-between items-center sticky top-0 z-50 shadow-sm backdrop-blur-md bg-white/90">
          ...
          <div className="flex items-center gap-6">
             <div className="hidden md:flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-full border border-slate-100">
                ...
                <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest italic">Support Protocol Active</span>
             </div>
        ...
        <main className="p-6 md:p-12 lg:p-16 max-w-7xl mx-auto w-full space-y-12 pb-32 lg:pb-16">
          ...
          >
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em] mt-3 italic">Monitor network activity and resolve institutional requests</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                 ...
                 >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-8 mb-16 relative z-10">
                       ...
                       <button className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] hover:text-slate-900 transition italic border-b border-slate-200 pb-1">Export Ledger_Node</button>
                    </div>
              ...
              <div className="space-y-12">
                 ...
                 >
                    ...
                    <p className="text-[11px] text-slate-400 mb-12 leading-relaxed font-black uppercase tracking-widest italic relative z-10">Institutional partners awaiting assistance. Node resolution threshold: 120 minutes.</p>
                    <button 
          ...
          {activeTab === 'kyc' && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-slate-200/60 p-10 md:p-16 rounded-[4rem] shadow-sm">
               <div className="flex items-center gap-4 mb-16">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 uppercase italic tracking-tighter">Identity Processing Queue</h3>
               </div>
               <div className="space-y-8">
                  <div className="py-32 text-center bg-slate-50 rounded-[3rem] border border-dashed border-slate-200 flex flex-col items-center gap-8 shadow-inner">
                     <ShieldCheck size={60} className="text-slate-100" />
                     <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] italic">Refer to Executive Manager for Identity Authorization</p>
                     <p className="text-[8px] text-slate-400 uppercase tracking-widest font-bold">Node Access Restricted to L2 Personnel</p>
                  </div>
               </div>
            </motion.div>
          )}
